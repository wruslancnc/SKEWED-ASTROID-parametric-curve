...
char CurveType[10] = "A23-SKWAST";
char CurveTypeDesc[80] = "SKEWED-ASTROID ALGO=23 SKIP STEP2 RUN-STEP1 RUN-ADJFR FRATECMD=10";
      ...
      if (fxn_cpos_epsilon (u, u_next) > uppertol_bound)
        {
          ...
          // DEBUG 8  ********************************
          // printf ("%s DEBUG 8 codeline 866 main - TO EXECUTE
          // fxn_get_u_next_with_constrained_eps \n", CurveType);

          // GO TO REDUCE EPS TO BELOW TOLERANCE
          // step1_unext = fxn_get_u_next_with_constrained_eps (u, u_next,
          // error_tol);
          ...
          // DEBUG 9  ********************************
          // printf ("%s DEBUG 9 codeline 873 main - COMPLETED
          // fxn_get_u_next_with_constrained_eps \n", CurveType);
...
*/ // END BYPASS STEP 2
      ...
      if ((fabs (u_static_after - u_static_before) < 1E-16) && (u_val_constant_1 == 1) && (u_val_constant_2 == 1) && (u_val_constant_3 == 1) && (u_val_constant_4 == 1) ){
          ...
          printf (" Execute exit(1) at line 1217 in main(). \n");
      ...
      if ((u_next < 1.0E-14) && (u_next_zero_1 == 1) && (u_next_zero_2 == 1) && (u_next_zero_3 == 1) && (u_next_zero_4 == 1)) {
          ...
          printf (" Execute exit(1) at line 1254 in main(). \n");
